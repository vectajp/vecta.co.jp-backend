/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb7941a85dea3e099efab1886811b4e3)
// Runtime types generated with workerd@1.20250508.0 2025-05-24 
declare namespace Cloudflare {
	interface Env {
		ADMIN_CORS_ALLOWED_ORIGINS: "http://127.0.0.1:5177,http://localhost:5177,https://admin.vecta.co.jp,https://vecta-admin.pages.dev,https://feature-swarrow-lead-api.vecta-admin.pages.dev";
		ENVIRONMENT: string;
		API_KEY: string;
		...
		DB: D1Database;
		IGNORED_COMPANY_REGISTRY: Fetcher /* vecta-ignored-company-registry */;
	}
}
